...
Before using the **Setup MATLAB** task to set up MATLAB and other MathWorks products on a self-hosted UNIX&reg; runner, verify that the required software is installed on your runner.
