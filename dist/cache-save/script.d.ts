 ...
 */
export declare function generateExecCommand(platform: string, scriptPath: string): Promise<string>;
export declare function defaultInstallRoot(platform: string, programName: string): string;
